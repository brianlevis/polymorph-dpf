...
INPUT_FEATURES = {
    ...
    'ad_network_id', 'ua_device', 'r_num_ads_third_party', 'creative_id', 'r_cnt', 'pub_network_id', 'geo_continent_code',
    'zone_id', 'r_num_ads_requested', 'rate_metric', 'geo_city_name', 'campaign_type', 'exp_mode', 'site_id',
    'geo_area_code', 'r_timestamp', 'ua_os', 'ua_device_type', 'ua_os_name'
}
